...
public:
    ...
    void blitFramebuffer(int srcX0, int srcY0, int srcX1, int srcY1,
                         int dstX0, int dstY0, int dstX1, int dstY1, GLuint dstFrameBuffer, GLsizei sampleCount) const;
    /// blit to default frame buffer
    void blitFramebuffer(int srcX0, int srcY0, int srcX1, int srcY1, int dstX0, int dstY0, int dstX1, int dstY1) const
    {
        blitFramebuffer(srcX0, srcY0, srcX1, srcY1, dstX0, dstY0, dstX1, dstY1,
                        0, GLWindow::get()->multisamplingCount);
    }
    void blitFramebuffer(int dstX0, int dstY0, int dstX1, int dstY1, const std::shared_ptr<FrameBuffer>& dst) const
    {
        blitFramebuffer(0, 0, (int)width, (int)height,
                        dstX0, dstY0, dstX1, dstY1, dst->getHandle(), samples);
    }
    void blitFramebuffer(int srcX0, int srcY0, int srcX1, int srcY1,
                         int dstX0, int dstY0, int dstX1, int dstY1, const std::shared_ptr<FrameBuffer>& dst) const
    {
        blitFramebuffer(srcX0, srcY0, srcX1, srcY1,  dstX0, dstY0, dstX1, dstY1, dst->getHandle(), samples);
    }
