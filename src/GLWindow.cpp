                                              ...
                                              GLsizei length, const char *message, const void *userParam)
{
    ...
    if(id == 131169 || id == 131185 || id == 131218 || id == 131204 || id == 8
        || id == 0x64 // AMD Radeon R5 430: Debug message (0x64): glLineWidth uses wide lines (parameter <width> with value '0x0') which are deprecated and do not work outside of the compatibility context, Source: API, Type: Deprecated Behaviour, Sev erity: low
        )
    {
        return;
    }
